...
export const LINEUP_DRAGONBALL_HOME_HERO_ASSET_PATH = "the_chronicle_of_goku_placeholder/lobby_hero.webp";  // M3.1 lobbyHero / M4 homeHero 식별자 개명. 자산 파일명은 그대로 (외부 작업).
...
export const TIERS_ONEPIECE = [
  ...
  { tier: "B", count: 2, typeCount: 2, tierClass: TIER_CLASS_HERO, nameJa: "モンキー・D・ルフィ MASTERLISE", nameKo: "몽키 D 루피 MASTERLISE", sizeLabel: "" },
  { tier: "C", count: 2, typeCount: 1, tierClass: TIER_CLASS_HERO, nameJa: "モンキー・D・ルフィ 海賊王におれはなる!!!! Revible Moment", nameKo: "몽키 D 루피 해적왕에 내가 되겠다!!!! Revible Moment", sizeLabel: "" },
  { tier: "D", count: 3, typeCount: 1, tierClass: TIER_CLASS_HERO, nameJa: "モンキー・D・ルフィ ギア5 ONDIMENSION", nameKo: "몽키 D 루피 기어5 ONDIMENSION", sizeLabel: "" },
  { tier: "E", count: 4, typeCount: 2, tierClass: TIER_CLASS_HERO, nameJa: "はこにわーるど", nameKo: "하코니와루도 (디오라마 박스)", sizeLabel: "" },
  { tier: "F", count: 6, typeCount: 3, tierClass: TIER_CLASS_HERO, nameJa: "モンキー・D・ルフィ ミニフィギュア", nameKo: "몽키 D 루피 미니 피규어", sizeLabel: "" },
...
export const LINEUP_ONEPIECE_HOME_HERO_ASSET_PATH = "monkey_d_luffy_placeholder/lobby_hero.webp";  // M3.1 lobbyHero / M4 homeHero 개명
...
export const HOME_GRID_COLS_MOBILE = 1;  // M3.1 LOBBY_GRID_COLS_MOBILE / M4 HOME_GRID_COLS_MOBILE 개명
export const HOME_GRID_COLS_TABLET = 2;
export const HOME_TABLET_BREAKPOINT_PX = 768;
...
LINEUPS.forEach(validateLineupTierClass);
